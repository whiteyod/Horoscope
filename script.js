const intro = [
    "Сегодня Вас ждет необычный день. ", 
    "День пройдет как обычно. ", 
    "Ваши действия с самого утра, могут повлиять на весь день. ", 
    "День может выдаться нелегким. ", 
    "Удача будет сопутствовать Вам на протяжении всего дня. "
]
